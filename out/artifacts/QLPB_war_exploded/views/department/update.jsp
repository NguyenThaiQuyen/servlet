...
<div class="right_col" role="main">
    ...
    <div class="x_panel">
        <div class="x_content">
            <br />
            <form class="form-horizontal form-label-left" action="<%= request.getContextPath() %>/UpdateDepartmentServlet" method="POST">
                <% Department d = (Department)request.getAttribute("dep"); %>
                <div class="form-group row ">
                    <label class="control-label col-md-3 col-sm-3 ">Name</label>
                    <div class="col-md-9 col-sm-9 ">
                        <input type="text" class="form-control" name="nameDep" value="<%= d.getName()%>">
                        <input type="text" class="form-control" hidden name="idPos" value="<%= d.getID()%>">
                    </div>
                </div>
                ...
                <div class="form-group row ">
                    ...
                    <div class="col-md-9 col-sm-9 ">
                        <input type="text" class="form-control" name="desdep" value="<%= d.getDescription() %>">
                    </div>
                </div>
